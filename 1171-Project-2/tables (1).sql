...
--Trigonometry 
--College English I 
SELECT COUNT(g.course_grade), c.course_id, c.course_title, g.course_grade
FROM courses AS c
INNER JOIN grades AS g
ON c.course_id=g.course_id
WHERE c.course_title IN ('FUNDAMENTALS OF COMPUTING', 'PROGRAMMING I', 'ALGEBRA 1', 'TRIGONOMETRY 1', 'COLLEGE ENGLISH I') --IN allows for multiple values
GROUP BY c.course_id, c.course_title, g.course_grade
ORDER BY COUNT(g.course_grade) DESC;
